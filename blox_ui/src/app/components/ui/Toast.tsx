...
/*
 * Documentation:
 * Toast — https://app.subframe.com/8e5300ed4201/library?component=Toast_2c7966c2-a95d-468a-83fe-bf196b95be7a
 * Button — https://app.subframe.com/8e5300ed4201/library?component=Button_3b777358-b86b-40af-9327-891efc6826fe
 */
...
const ToastRoot = React.forwardRef<HTMLElement, ToastRootProps>(function ToastRoot(
  {
    variant = 'neutral',
    icon = <FeatherInfo />,
    title,
