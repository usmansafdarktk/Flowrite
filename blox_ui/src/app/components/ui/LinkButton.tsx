...
/*
 * Documentation:
 * Link Button — https://app.subframe.com/8e5300ed4201/library?component=Link+Button_a4ee726a-774c-4091-8c49-55b659356024
 */
...
const LinkButtonRoot = React.forwardRef<HTMLElement, LinkButtonRootProps>(function LinkButtonRoot(
  {
    variant = 'neutral',
    size = 'medium',
    icon = null,
