...
/*
 * Documentation:
 * Radio Group — https://app.subframe.com/8e5300ed4201/library?component=Radio+Group_c4b6300e-20b4-4f3e-8b9f-379a046674ca
 */
...
const RadioGroupRoot = React.forwardRef<HTMLElement, RadioGroupRootProps>(function RadioGroupRoot(
  {
    label,
    helpText,
    error = false,
