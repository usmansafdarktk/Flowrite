...
/*
 * Documentation:
 * Tooltip — https://app.subframe.com/8e5300ed4201/library?component=Tooltip_ccebd1e9-f6ac-4737-8376-0dfacd90c9f3
 */
...
const TooltipRoot = React.forwardRef<HTMLElement, TooltipRootProps>(function TooltipRoot(
