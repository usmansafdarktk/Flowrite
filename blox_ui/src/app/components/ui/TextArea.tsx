...
/*
 * Documentation:
 * Text Area — https://app.subframe.com/8e5300ed4201/library?component=Text+Area_4ec05ee8-8f1c-46b2-b863-5419aa7f5cce
 */
...
const TextAreaRoot = React.forwardRef<HTMLElement, TextAreaRootProps>(function TextAreaRoot(
  {
    error = false,
    variant = 'outline',
    label,
